...
const AddStudent = (props) => {
  ...
  //   const ukrName = React.createRef();
  //   const ukrSurname = React.createRef();
  //   const ukrMiddleName = React.createRef();
  //   const engName = React.createRef();
  //   const engSurname = React.createRef();
  //   const engMiddleName = React.createRef();

  // const code = React.createRef();
  // const registerNumber = React.createRef();
  // const profession = React.createRef();
  // const daybookNumber = React.createRef();
